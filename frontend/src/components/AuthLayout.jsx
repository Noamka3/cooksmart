            ...
            <div style={{ maxWidth: 380, width:"100%", margin:"0 auto" }}>
              ...
              <h1
                style={{
                  ...
                  fontWeight:900, color:"#fafaf9",
                  marginBottom:10, lineHeight:1.15, letterSpacing:"-0.01em",
                }}
              >
                {title}
              </h1>
              ...
              {alternateText && (
                <p style={{ marginTop:24, fontSize:"0.88rem", color:"rgba(250,250,249,0.45)", textAlign:"center" }}>
                  ...
                  <Link
                    to={alternateLink}
                    style={{ color:ORANGE, fontWeight:700, textDecoration:"none", transition:"opacity .2s" }}
